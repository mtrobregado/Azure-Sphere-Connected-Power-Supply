...
// Defines how quickly the DPS3005 Power Supply data is read and reported
#define PSUPPLY_READ_PERIOD_SECONDS 3
#define PSUPPLY_READ_PERIOD_NANO_SECONDS 0

// Defines how quickly the DPS3005 Power Supply data is read and reported
#define PSUPPLY_WRITE_PERIOD_SECONDS 3
#define PSUPPLY_WRITE_PERIOD_NANO_SECONDS 0
